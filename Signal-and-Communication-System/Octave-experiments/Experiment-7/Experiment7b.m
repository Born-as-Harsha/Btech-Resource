% Part (b): Sampling Frequency 1200 Hz
clear all;
close all;
...
grid on;
title('Original and Sampled Signals ($f_s = 1200$ Hz)');
xlabel('Time (s)');
ylabel('Amplitude');
legend;
...
grid on;
title('Frequency Spectrum ($f_s = 1200$ Hz)');
xlabel('Frequency (Hz)');
ylabel('Magnitude');
% The spectrum will show peaks at 190 Hz and 420 Hz (and their negative counterparts).
